<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__wobble" src="{{ asset('img/graduation.png') }}" alt="graduation" height="500"
            width="500">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">REPALTY MAYER SINAGA</a>
                </div>
            </div>
    ...
    <footer class="main-footer">
        ...
        <span> </span>
        <strong><img src="{{ asset('img/gmail.png') }}" alt="gmail"
                style="width: 60px;height: 60px">sman5medan@gmail.com </strong>
        <span>|</span>
        <strong><img src="{{ asset('img/wa.png') }}" alt="wa"
                style="width: 60px;height: 60px">082168476336</strong>
        <span>|</span>

        <strong><img src="{{ asset('img/instagram.png') }}" alt="ig"
                style="width: 60px;height: 60px">@smanlimedan</strong>
